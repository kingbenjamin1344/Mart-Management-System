        ...
        <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
          ...
          <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="../Categories/index.php"><i class="fa fa-home"></i> Home</a>
              </li>
              <li class="nav-item">
                ...
                <a class="nav-link" href="../Contact/read.php"><i class="fa fa-envelope"></i> Contact</a>
              </li>
            </ul>
          </div>
        </div>
...
<body>
    <div class="container">
        <div class="profile-card">
            <img src="test.jpg" alt="Profile Picture" class="profile-picture">
            <h1>John Rey Excel B. Rementizo</h1>
